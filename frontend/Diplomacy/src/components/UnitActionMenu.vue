<template>
  <g>
    ...
    <!-- TODO: Conditional rendering of convoy button based on unit location -->
    <use v-if="type == 'F'" v-bind="{'xlink:href' : '#ConvoyButton'}" :id="'convoy-'+unit_id" :transform="'translate(' + (positionX - 28) + ', ' + (positionY + 20) + ')'" class="action-button"/>
  </g>
</template>
