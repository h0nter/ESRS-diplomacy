...
class Unit(models.Model):
    ...
    owner = models.OneToOneField(Country,on_delete=models.CASCADE)
...
class Order(models.Model):
    ...
    turn = models.OneToOneField(Turn, on_delete=models.DO_NOTHING) # Not null
    target_unit = models.OneToOneField(Unit,on_delete=models.DO_NOTHING,related_name='target_unit') # Not null
    current_location = models.OneToOneField(Location,on_delete=models.DO_NOTHING,related_name='current_location') # Not null
    # convoy operation only
    reference_unit = models.OneToOneField(Unit,null=True,on_delete=models.DO_NOTHING,related_name='reference_unit')
    reference_unit_current_location = models.OneToOneField(Location,null=True,on_delete=models.DO_NOTHING,related_name='reference_unit_current_location')
    reference_unit_new_location = models.OneToOneField(Location,null=True,on_delete=models.DO_NOTHING,related_name='reference_unit_new_location')
